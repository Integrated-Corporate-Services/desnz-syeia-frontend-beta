 ...
 * Values are read from runtime environment variables with fallback defaults
 * 
 * Default behavior:
...
import { getRuntimeEnvNumber, getRuntimeEnv } from '../config/runtimeConfig';
...
export const SESSION_TIMEOUT = getRuntimeEnvNumber('VITE_SESSION_TIMEOUT_SECONDS', 1800);
...
export const SESSION_WARNING = getRuntimeEnvNumber('VITE_SESSION_WARNING_SECONDS', 120);
