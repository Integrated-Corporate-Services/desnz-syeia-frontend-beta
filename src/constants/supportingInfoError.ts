// Error messages for SupportingInfo feature
export const SUPPORTING_INFO_ERRORS = {
  WAYLEAVES_REQUIRED: "Select 'Yes' or 'No'",
  WAYLEAVES_REASON_REQUIRED: 'Enter details about why wayleaves have not been obtained and the estimated timeline to obtain them',
