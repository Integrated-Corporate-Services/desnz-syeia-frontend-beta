...
// Get user type from environment variable (defaults to DNO_TEAM_COORDINATOR)
const DUMMY_USER_TYPE =
  (import.meta.env.VITE_DUMMY_USER_TYPE as string) || "DNO_TEAM_COORDINATOR";
const currentDummyUser =
  DUMMY_USERS[DUMMY_USER_TYPE] || DUMMY_USERS.DNO_TEAM_COORDINATOR;
