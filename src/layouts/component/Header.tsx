...
const Header = () => {
  ...
  return (
    ...
    `}</style>
      <header className="govuk-header govuk-header--full-width-border" role="banner" style={{ background: '#2078c5', paddingBottom: 0 }}>
      <div className="govuk-header__container govuk-width-container">
        <div className="govuk-header__logo">
        <a href="/" className="govuk-header__link govuk-header__link--homepage" style={{ textDecoration: 'none' }}>
