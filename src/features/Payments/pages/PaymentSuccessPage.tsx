            ...
            <table className="govuk-table">
              <tbody className="govuk-table__body">
                <tr className="govuk-table__row">
                  ...
                  <td className="govuk-table__cell">{loading && !reference ? 'Loading...' : reference || 'N/A'}</td>
                </tr>
                <tr className="govuk-table__row">
                  <th scope="row" className="govuk-table__header">Invoice number</th>
                  <td className="govuk-table__cell">{loading && !invoiceNumber ? 'Loading...' : invoiceNumber || 'N/A'}</td>
                </tr>
                <tr className="govuk-table__row">
