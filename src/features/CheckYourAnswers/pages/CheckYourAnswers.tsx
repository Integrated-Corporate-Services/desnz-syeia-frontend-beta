          ...
          <div className="govuk-grid-column-two-thirds">
            ...
            >
              ...
              <div className="govuk-notification-banner__content">
                <p className="govuk-notification-banner__heading"></p>
                <p className="govuk-body">All sections on the task list must be completed before this application can be submitted</p>
                <p></p>
              </div>
            </div>
            <h1 className="govuk-heading-xl">Check your answers before submitting your Section 37 application</h1>
            <div
            ...
            >
              <div className="govuk-accordion__controls">
                <button type="button" className="govuk-accordion__show-all" aria-expanded="true">
              ...
              <div className="govuk-accordion__section govuk-accordion__section--expanded">
                <div className="govuk-accordion__section-header">
                  <h2 className="govuk-accordion__section-heading">
                    <button type="button" aria-controls={`${applicationId}-content-1`} className="govuk-accordion__section-button" aria-expanded="true" aria-label="Application documents , Hide this section">
              ...
              <div className="govuk-accordion__section govuk-accordion__section--expanded">
                <div className="govuk-accordion__section-header">
                  <h2 className="govuk-accordion__section-heading">
                    <button type="button" aria-controls={`${applicationId}-content-2`} className="govuk-accordion__section-button" aria-expanded="true" aria-label="Applicant details , Hide this section">
              ...
              <div className="govuk-accordion__section govuk-accordion__section--expanded">
                <div className="govuk-accordion__section-header">
                  <h2 className="govuk-accordion__section-heading">
                    <button type="button" aria-controls={`${applicationId}-content-3`} className="govuk-accordion__section-button" aria-expanded="true" aria-label="Project details , Hide this section">
              ...
              <div className="govuk-accordion__section govuk-accordion__section--expanded">
                <div className="govuk-accordion__section-header">
                  <h2 className="govuk-accordion__section-heading">
                    <button type="button" aria-controls={`${applicationId}-content-4`} className="govuk-accordion__section-button" aria-expanded="true" aria-label="Location , Hide this section">
              ...
              <div className="govuk-accordion__section govuk-accordion__section--expanded">
                <div className="govuk-accordion__section-header">
                  <h2 className="govuk-accordion__section-heading">
                    <button type="button" aria-controls={`${applicationId}-content-5`} className="govuk-accordion__section-button" aria-expanded="true" aria-label="Supporting information , Hide this section">
              ...
              <div className="govuk-accordion__section govuk-accordion__section--expanded">
                <div className="govuk-accordion__section-header">
                  <h2 className="govuk-accordion__section-heading">
                    <button type="button" aria-controls={`${applicationId}-content-6`} className="govuk-accordion__section-button" aria-expanded="true" aria-label="Further information , Hide this section">
            ...
            <form action={`${S37_BASE_URL}/submit`} method="post" data-module="fds-html-form">
              {/* If you need a CSRF token, add it here as a hidden input */}
