          ...
          <div className="govuk-grid-column-two-thirds">
            ...
            >
              ...
              >
                ...
                {expandedSections[0] && (
                  <div
                    id={`${applicationId}-content-1`}
                    className="govuk-accordion__section-content"
                  >
                    {/* Project overview summary card */}
                    <div
                      className="govuk-summary-card"
                      id="application-documents-project-details"
                    >
              ...
              >
                  ...
                  <h2 className="govuk-accordion__section-heading">
                    <button
                      ...
                      aria-label={`Applicant details , ${
                        expandedSections[1] ? "Hide" : "Show"
                      } this section`}
                      onClick={() => handleToggle(1)}
                    >
                      <span
                        className="govuk-accordion__section-heading-text"
                        id={`${applicationId}-heading-2`}
                      >
                        <span className="govuk-accordion__section-heading-text-focus">
                          Applicant details
                        </span>
                ...
                {expandedSections[1] && (
                  <div
                    id={`${applicationId}-content-2`}
                    className="govuk-accordion__section-content"
                  >
                    {/* Network operator details summary card */}
                    <div
                      className="govuk-summary-card"
                      id="network-operator-details"
                    >
                      <div className="govuk-summary-card__title-wrapper">
                        <h2 className="govuk-summary-card__title">
                      ...
                      <div className="govuk-summary-card__content">
                        <dl className="govuk-summary-list">
                          ...
                          <div className="govuk-summary-list__row govuk-summary-list__row--no-actions ">
                            ...
                            <dd className="govuk-summary-list__value">
                              Section 37 Consent Npower User
                            </dd>
                          </div>
                        </dl>
                      </div>
                    ...
                    <div
                      className="govuk-summary-card"
                      id="network-operator-contact-details"
                    >
                      <div className="govuk-summary-card__title-wrapper">
                        <h2 className="govuk-summary-card__title">
                      ...
                      <div className="govuk-summary-card__content">
                        <dl className="govuk-summary-list">
                          ...
                          <div className="govuk-summary-list__row govuk-summary-list__row--no-actions ">
                            ...
                            <dd className="govuk-summary-list__value">
                              <a
                                href="mailto:s37_user.npower@eip.co.uk"
                                className="govuk-link"
                              >
                                s37_user.npower@eip.co.uk
                              </a>
                            </dd>
                          </div>
                          <div className="govuk-summary-list__row govuk-summary-list__row--no-actions ">
                  ...
                  <h2 className="govuk-accordion__section-heading">
                    <button
                      ...
                      aria-label={`Project details , ${
                        expandedSections[2] ? "Hide" : "Show"
                      } this section`}
                      onClick={() => handleToggle(2)}
                    >
                      <span
                        className="govuk-accordion__section-heading-text"
                        id={`${applicationId}-heading-3`}
                      >
                        <span className="govuk-accordion__section-heading-text-focus">
                          Project details
                        </span>
                    ...
                    <div className="govuk-summary-card" id="asset-information">
                      ...
                      <div className="govuk-summary-card__content">
                        <dl className="govuk-summary-list">
                          ...
                          <div className="govuk-summary-list__row govuk-summary-list__row--no-actions ">
                            <dt className="govuk-summary-list__key">
                              Are you adding or replacing poles?
                            </dt>
                            <dd className="govuk-summary-list__value"></dd>
                          </div>
                          <div className="govuk-summary-list__row govuk-summary-list__row--no-actions ">
                            <dt className="govuk-summary-list__key">
                              Are you adding or replacing overhead lines?
                            </dt>
                            <dd className="govuk-summary-list__value"></dd>
                          </div>
                          <div className="govuk-summary-list__row govuk-summary-list__row--no-actions ">
                            <dt className="govuk-summary-list__key">
                              Are you removing any existing equipment as part of
                              this project?
                            </dt>
                            <dd className="govuk-summary-list__value"></dd>
                          </div>
                          <div className="govuk-summary-list__row govuk-summary-list__row--no-actions ">
                            <dt className="govuk-summary-list__key">
                              Are the works to be carried out on an existing
                              asset?
                            </dt>
                            <dd className="govuk-summary-list__value"></dd>
                          </div>
              ...
              >
                <div className="govuk-accordion__section-header">
                  <h2 className="govuk-accordion__section-heading">
                    <button
                      ...
                      aria-label={`Location , ${
                        expandedSections[3] ? "Hide" : "Show"
                      } this section`}
                      onClick={() => handleToggle(3)}
                    >
                      <span
                        className="govuk-accordion__section-heading-text"
                        id={`${applicationId}-heading-4`}
                      >
                        <span className="govuk-accordion__section-heading-text-focus">
                          Location
                        </span>
                ...
                {expandedSections[3] && (
                  <div
                    id={`${applicationId}-content-4`}
                    className="govuk-accordion__section-content"
                  >
                    {/* Route summary card */}
                    <h3 className="govuk-heading-s">Routes</h3>
                    <div className="govuk-inset-text">
                      Maps can't be shown in Internet Explorer. Use a different
                      web browser to view the route map.
                    </div>
              ...
              >
                  ...
                  <h2 className="govuk-accordion__section-heading">
                    <button
                      ...
                      aria-label={`Supporting information , ${
                        expandedSections[4] ? "Hide" : "Show"
                      } this section`}
                      onClick={() => handleToggle(4)}
                    >
                      <span
                        className="govuk-accordion__section-heading-text"
                        id={`${applicationId}-heading-5`}
                      >
                        <span className="govuk-accordion__section-heading-text-focus">
                ...
                {expandedSections[4] && (
                  <div
                    id={`${applicationId}-content-5`}
                    className="govuk-accordion__section-content"
                  >
                    <div className="govuk-inset-text">
                      No supporting information has been submitted to this
                      application
                    </div>
                  </div>
                )}
              ...
              >
                  ...
                  <h2 className="govuk-accordion__section-heading">
                    <button
                      ...
                      aria-label={`Further information , ${
                        expandedSections[5] ? "Hide" : "Show"
                      } this section`}
                      onClick={() => handleToggle(5)}
                    >
                      <span
                        className="govuk-accordion__section-heading-text"
                        id={`${applicationId}-heading-6`}
                      >
                        <span className="govuk-accordion__section-heading-text-focus">
                          Further information
                        </span>
                ...
                {expandedSections[5] && (
                  <div
                    id={`${applicationId}-content-6`}
                    className="govuk-accordion__section-content"
                  >
                    <div className="govuk-inset-text">
                      No further information has been submitted to this
                      application
                    </div>
                  </div>
                )}
            ...
            <div className="govuk-form-group" style={{ marginTop: "2em" }}>
            ...
            >
              {isSubmitting ? "Submitting..." : "Accept and send application"}
            </button>

            <form
              action={`${S37_BASE_URL}/submit`}
              method="post"
