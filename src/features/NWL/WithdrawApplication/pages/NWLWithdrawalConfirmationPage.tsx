...
import { WITHDRAWAL_LABELS } from '../constants';
...
const NWLWithdrawalConfirmationPage: React.FC = () => {
            ...
            <main className="govuk-main-wrapper" id="main-content" role="main">
                <div className="govuk-grid-row">
                    <div className="govuk-grid-column-two-thirds">
                        ...
                        <p className="govuk-body">{WITHDRAWAL_LABELS.CONFIRMATION_MESSAGE_1}</p>

                        <p className="govuk-body">{WITHDRAWAL_LABELS.CONFIRMATION_MESSAGE_2}</p>

                        <p className="govuk-body">{WITHDRAWAL_LABELS.CONFIRMATION_MESSAGE_3}</p>

                        <div className="govuk-inset-text">
                            {WITHDRAWAL_LABELS.MISTAKE_MESSAGE}{' '}
                            <a href="mailto:S37consents@energysecurity.gov.uk" className="govuk-link">
...
export default NWLWithdrawalConfirmationPage;
