...
export const FORM_ERRORS = {
  ...
  INVALID_REFERENCE: "Applicant's reference can only include letters, numbers, spaces and hyphens",
  REFERENCE_TOO_LONG: "You cannot enter more than 24 characters",
