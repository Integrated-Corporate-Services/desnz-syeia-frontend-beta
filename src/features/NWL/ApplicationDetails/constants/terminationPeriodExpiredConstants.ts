...
export const LABELS = {
  ...
  HELPER_TEXT: "If the termination period has not expired, a Notice to Remove cannot be served by the objector. You should not make an application until the termination period has expired.",
} as const;
