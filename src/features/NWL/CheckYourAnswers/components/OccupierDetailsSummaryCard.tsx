...
export const OccupierDetailsSummaryCard: React.FC<Props> = ({ data, applicationId, canEdit = true }) => {
    ...
    // Title
    rows.push(createSummaryRow(CONSTANTS.OCCUPIER_FIELDS.TITLE, data.title || CONSTANTS.DEFAULTS.NOT_PROVIDED));

    // Name
    rows.push(createSummaryRow(CONSTANTS.OCCUPIER_FIELDS.NAME, data.name || CONSTANTS.DEFAULTS.NOT_PROVIDED));

    // Organisation
    rows.push(createSummaryRow(CONSTANTS.OCCUPIER_FIELDS.ORGANISATION, data.organisation || CONSTANTS.DEFAULTS.DASH));
